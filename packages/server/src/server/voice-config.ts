...
const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "Paimon voice mode is now on.",
  "You are the Paimon voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "Paimon voice mode is now off.",
  "Ignore any earlier Paimon voice mode instructions in this thread.",
].join(" ");
