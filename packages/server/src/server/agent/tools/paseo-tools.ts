...
export function createPaseoToolCatalog(options: PaseoToolHostDependencies): PaseoToolCatalog {
  ...
  const toCatalog = (): PaseoToolCatalog => ({
    ...
    async executeTool(
      ...
      if (!tool) {
        throw new Error(`Paimon tool not found: ${name}`);
      }
    ...
    z
      .object({
        ...
        worktreeSlug: z
          ...
          .min(1)
          .optional()
          .describe("Optional worktree slug/path label. Omit to let Paimon generate one."),
        branchName: z
          .string()
          .min(1)
          .optional()
      ...
      .strict()
      .describe("Create a new branch in a new Paimon worktree."),
    z
      .object({
      ...
      .strict()
      .describe("Check out an existing branch in a new Paimon worktree."),
    z
      .object({
      ...
      .strict()
      .describe("Check out a GitHub pull request in a new Paimon worktree."),
  ]);
  ...
  registerTool(
    "create_workspace",
    {
      ...
      description:
        "Create a workspace using an existing local checkout or a new Paimon-managed worktree.",
      inputSchema: {
        isolation: z.enum(["local", "worktree"]),
        path: z
          .string()
  ...
  registerTool(
    "start_workspace_script",
    {
      ...
      description:
        "Start one configured workspace script through Paimon's managed workspace-script launcher.",
      inputSchema: {
