...
export const es: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      rail: {
        ...
        skills: "Skills",
        moreItems: "{{count}} más",
        expand: "Abrir panel de entorno",
        collapse: "Contraer panel de entorno",
        detached: "HEAD desacoplado",
        dirty: "Cambios sin confirmar",
        clean: "Árbol de trabajo limpio",
        placeholder: "Mensaje de commit (vacío para generar automáticamente)…",
        generating: "Generando...",
        emptyMessage: "Introduce primero un mensaje de commit",
  ...
  sidebar: {
    ...
    actions: {
      ...
      jumpToActivity: "Ir a la actividad",
    },
    help: {
  ...
  newWorkspace: {
    ...
    standaloneTitle: "Nueva sesión independiente",
    create: "Crear",
    isolation: {
      local: "Local",
