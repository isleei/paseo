...
export const zhCN: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      rail: {
        ...
        tasksList: "任务清单",
        artifacts: "产物",
        artifactsIntermediate: "中间产物",
        sources: "参考",
        sourcesWeb: "联网搜索",
        sourcesUpload: "用户上传",
        sourcesProject: "项目文件",
        uploadedCount: "{{count}} 个附件",
        skills: "技能",
        ...
        generating: "生成中...",
        emptyMessage: "请先输入提交信息",
        commitOrPush: "提交或推送",
        commitAndPush: "提交并推送",
        commitPushing: "推送中...",
        pushing: "推送中...",
        openPullRequest: "打开 Pull Request #{{number}}",
        noTasks: "暂无任务",
        noArtifacts: "暂无产物",
        noSources: "暂无参考",
        prUnavailable: "无法获取拉取请求状态",
        includeUnstagedChanges: "包含未暂存的更改",
      },
      actions: {
        moreOptions: "更多选项",
        moreActions: "更多操作",
        ...
        unavailable: {
          ...
          archiveNotWorktree: "此处无法归档，因为此 workspace 不是作为 Paimon worktree 创建的",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "管理内置 daemon",
        hint: "让 Paimon 启动和停止内置 daemon",
        pauseTitle: "暂停内置 daemon",
        pauseMessage:
          "这会立即停止内置 daemon。连接到内置 daemon 的运行中 agents 和 terminals 会被停止。",
        pauseAndStop: "暂停并停止",
        registrationFailed:
          "内置 daemon 已启动，但 Paimon 无法保存 localhost 连接。请关闭后重新开启 daemon 管理，或手动添加 localhost。",
        pausedStopFailed: "内置 daemon 管理已暂停，但 Paimon 无法停止 daemon。",
        updateFailed: "无法更新内置 daemon 管理设置。",
      },
      keepRunning: {
        title: "退出后保持 daemon 运行",
        hint: "退出 Paimon 后 daemon 会继续运行",
      },
      logs: {
        title: "日志文件",
    ...
    rosetta: {
      ...
      runningIntel: "你正在 Apple Silicon 上通过 Rosetta 运行 Paimon 的 Intel 构建。",
  ...
  pairing: {
    ...
    remoteSsh: {
      title: "远程 SSH",
      helper: "连接到远程主机上运行的 Paimon 守护进程。",
      fields: {
        target: "SSH 主机",
      },
      actions: {
    ...
    device: {
      ...
      relayDocs: "中继如何工作",
      relayDocsAccessibility: "阅读 Paimon 中继的工作原理",
      enableRelay: "启用中继",
      enablingRelay: "正在启用...",
      notNow: "暂不",
      directConnectionHint:
        "不使用中继时，请通过 TCP、Tailscale 或其他 VPN 直接连接。不会生成二维码。",
      updateRequired: "请更新主机，以便从 Paimon Desktop 启用中继。",
      unavailable: "配对 offer 不可用。",
      hint: "用手机上的 Paimon 扫描此二维码，或复制下方链接。",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "调用了 Paimon {{count}} 次",
      other: "调用了 Paimon {{count}} 次",
    },
    and: "并",
  },
  renameModal: {
  ...
  contextWindow: {
    ...
    accessibility: "上下文用量已使用 {{percentage}}%",
  },
  review: {
    comment: {
      add: "添加 review 评论",
  ...
  settings: {
    ...
    notifications: {
      ...
      sending: "正在发送...",
      sentTitle: "测试通知已发送",
      sentDescription: "Paimon 已将通知交给操作系统。",
      sendFailedTitle: "无法发送测试通知",
    },
    island: {
      title: "灵动岛",
      enabled: "显示灵动岛",
      enabledHint: "在 Mac 菜单栏显示 Agent 状态浮岛。",
      dismissHint: "清除浮岛卡片",
      dismissHintDetail: "打开对应 Agent 即可清除它的卡片；完成与出错卡片稍后会自动消失。",
      mascot: "图标皮肤",
    },
    hostSections: {
      projects: "项目",
    ...
    metadataGeneration: {
      title: "元数据生成",
      description: "选择 Paimon 用于工作区标题、分支名称、提交消息和拉取请求草稿的模型",
      selection: "模型选择",
      automatic: "自动",
      preferred: "手动",
      automaticHint: "Paimon 会选择一个可用的快速模型",
      preferredHint: "选择 Paimon 使用的模型",
      model: "模型",
      fallbackHint: "如果不可用，Paimon 会改用其他可用模型",
      docs: "文档",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "浏览器标签页在 Paimon 中共享登录状态和网站数据。",
        clear: "清除浏览器数据",
        clearing: "正在清除...",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "这会更新此电脑上的 Paimon",
        installConfirm: "安装更新",
        update: "更新",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "更新 Paimon skills？",
        updateFallback: "将内置 skills 同步到你的机器。",
        uninstallTitle: "卸载 Paimon skills？",
        uninstallMessage: "会从 ~/.agents、~/.claude、~/.codex 移除所有 Paimon 编排 skills。",
        choose: "选择 skills",
        chooseAll: "全部 skills",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "启用 Paimon tools",
          hint: "Agent 将能够管理 worktree、Agent 和计划",
          accessibilityLabel: "注入 Paimon tools",
        },
        systemPrompt: {
          title: "System prompt",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage: "这个 Host 已离线。Paimon 会自动重连，请等它恢复在线后再重启。",
          requestFailedTitle: "错误",
          requestFailedMessage: "发送重启请求失败。Paimon 会自动重连，请在 Host 显示在线后重试。",
          dialogFailedMessage: "无法打开重启确认对话框。",
        },
        update: {
          desktopManagedHint: "此 Daemon 由 Paimon Desktop 管理。请在 Host 上更新 Paimon Desktop。",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        editScript: "编辑 {{name}}",
        runAsService: "作为服务运行",
        serviceHint: "Paimon 会监管该进程，并通过 $PASEO_PORT 分配端口",
        actions: {
          add: "添加 script",
          edit: "编辑",
          remove: "移除",
      ...
      metadata: {
        title: "元数据生成",
        info: "注入到 Paimon 用来生成元数据的 AI prompts 中的 Project 专属指令，可用于强制执行团队约定，例如分支命名、提交风格或 PR 格式",
        branchName: "分支名称",
