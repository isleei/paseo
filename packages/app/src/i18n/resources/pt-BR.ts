...
export const ptBR: TranslationResources = {
  ...
  composer: {
    ...
    tokenRate: {
      unit: "tokens/s",
      tokensLabel: "tokens",
      cacheLabel: "taxa de acerto de cache",
    },
    input: {
  ...
  workspace: {
    ...
    git: {
      rail: {
        ...
        sources: "Sources",
        sourcesWeb: "Web",
        sourcesUpload: "Uploaded",
        sourcesProject: "Project files",
        uploadedCount: "{{count}} attachment(s)",
        skills: "Skills",
        moreItems: "mais {{count}}",
        expand: "Abrir painel de ambiente",
        collapse: "Recolher painel de ambiente",
        detached: "HEAD desanexado",
        dirty: "Alterações não commitadas",
        clean: "Árvore de trabalho limpa",
        placeholder: "Mensagem de commit (vazio para gerar automaticamente)…",
        generating: "Gerando...",
        emptyMessage: "Informe uma mensagem de commit primeiro",
        commitAndPush: "Commit e push",
        commitPushing: "Enviando...",
        pushing: "Enviando...",
        openPullRequest: "Abrir pull request nº {{number}}",
        environmentInfo: "Ambiente",
        inspector: "Inspetor",
        commitOrPush: "Confirmar ou enviar",
        noTasks: "Sem tarefas",
        noArtifacts: "Sem artefatos",
        noSources: "Sem fontes",
        prUnavailable: "Status do PR indisponível",
        includeUnstagedChanges: "Incluir alterações não preparadas",
      },
      actions: {
        ...
        commit: {
          ...
          generateFailed: "Unable to generate a commit message",
          sheet: {
            title: "Commit changes",
            label: "Commit message",
            placeholder: "Describe the change",
            hint: "Leave empty to auto-generate on submit.",
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Arquivar não está disponível aqui porque este workspace não foi criado como um worktree do Paimon",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Permitir que o Paimon inicie e pare o daemon integrado",
        ...
        registrationFailed:
          "O daemon integrado foi iniciado, mas o Paimon não conseguiu salvar a conexão localhost. Desative e reative o gerenciamento do daemon ou adicione localhost manualmente.",
        pausedStopFailed:
          "O gerenciamento do daemon integrado foi pausado, mas o Paimon não conseguiu parar o daemon.",
        updateFailed: "Não foi possível atualizar o gerenciamento do daemon integrado.",
      },
      keepRunning: {
        title: "Manter daemon em execução ao sair",
        hint: "O daemon continua em execução quando você sai do Paimon",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Você está executando a build Intel do Paimon pelo Rosetta no Apple Silicon.",
    ...
    permissions: {
      ...
      testNotification: {
        title: "Teste de notificação do Paimon",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Não foi possível instalar a CLI do Paimon.",
      },
    },
  },
  rootError: {
    title: "O Paimon encontrou um problema.",
  ...
  pairing: {
    ...
    direct: {
      title: "Conexão direta",
      helper: "Informe o endereço de um servidor Paimon.",
      fields: {
        host: "Host",
        port: "Porta",
        password: "Senha",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conecte-se a um daemon Paimon no host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leia como o relay do Paimon funciona",
      ...
      updateRequired: "Atualize o host para ativar o relay pelo Paimon Desktop.",
      unavailable: "Oferta de pareamento indisponível.",
      hint: "Escaneie este QR code com o Paimon no seu celular ou copie o link abaixo.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "chamou o Paimon {{count}} vez",
      other: "chamou o Paimon {{count}} vezes",
    },
    and: "e",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "O Paimon entregou a notificação ao sistema operacional.",
      sendFailedTitle: "Não foi possível enviar a notificação de teste",
    },
    island: {
      title: "Agent Island",
      enabled: "Mostrar Agent Island",
      enabledHint: "Mostra uma pílula flutuante de status do agente na barra de menus.",
      dismissHint: "Dispensar cartões",
      dismissHintDetail:
        "Abra um agente para dispensar seu cartão. Cartões de conclusão e erro somem sozinhos.",
      mascot: "Mascote",
    },
    hostSections: {
      projects: "Projetos",
    ...
    metadataGeneration: {
      ...
      description:
        "Escolha o modelo usado pelo Paimon para títulos de espaços de trabalho, nomes de branches, mensagens de commit e rascunhos de pull request",
      selection: "Seleção de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "O Paimon escolhe um modelo rápido disponível",
      preferredHint: "Escolha o modelo que o Paimon usa",
      model: "Modelo",
      fallbackHint: "Se ele não estiver disponível, o Paimon usa outro modelo disponível",
      docs: "Documentação",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "As abas do navegador compartilham logins e dados de sites no Paimon.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Isso atualiza o Paimon neste computador",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Atualizar Paimon skills?",
        updateFallback: "Sincronize as skills incluídas com sua máquina.",
        uninstallTitle: "Desinstalar Paimon skills?",
        uninstallMessage:
          "Remove todas as skills de orquestração do Paimon de ~/.agents, ~/.claude e ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Ativar ferramentas do Paimon",
          hint: "Agentes poderão gerenciar worktrees, agentes e agendamentos",
          accessibilityLabel: "Injetar ferramentas do Paimon",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este host está offline. O Paimon reconecta automaticamente. Aguarde ele voltar a ficar online antes de reiniciar.",
          requestFailedTitle: "Erro",
          requestFailedMessage:
            "Falha ao enviar a solicitação de reinício. O Paimon reconecta automaticamente. Tente novamente quando o host aparecer como online.",
          dialogFailedMessage: "Não foi possível abrir o diálogo de confirmação de reinício.",
        },
        update: {
          desktopManagedHint:
            "Este daemon é gerenciado pelo Paimon Desktop. Atualize o Paimon Desktop no host.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "O Paimon supervisiona o processo e atribui uma porta via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Geração de metadados",
        info: "Instruções específicas do projeto injetadas nos prompts de IA que o Paimon usa para gerar metadados. Use-as para aplicar convenções da sua equipe, como nomes de branch, estilo de commit ou formato de PR",
