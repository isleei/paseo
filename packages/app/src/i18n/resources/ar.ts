  ...
  workspace: {
    ...
    git: {
      rail: {
        ...
        expand: "فتح لوحة البيئة",
        collapse: "طي لوحة البيئة",
        detached: "HEAD منفصل",
        dirty: "تغييرات غير مُودعة",
        clean: "شجرة العمل نظيفة",
        placeholder: "رسالة الإيداع (اتركها فارغة للتوليد التلقائي)…",
        generating: "جارٍ التوليد...",
        emptyMessage: "أدخل رسالة الإيداع أولاً",
