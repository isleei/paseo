  ...
  workspace: {
    ...
    git: {
      rail: {
        ...
        skills: "Skills",
        moreItems: "ещё {{count}}",
        expand: "Открыть панель окружения",
        collapse: "Свернуть панель окружения",
        detached: "Отсоединённый HEAD",
        dirty: "Есть незакоммиченные изменения",
        clean: "Рабочее дерево чистое",
        placeholder: "Сообщение коммита (пусто — сгенерировать автоматически)…",
        generating: "Генерация...",
        emptyMessage: "Сначала введите сообщение коммита",
